...
import com.zhu.framework.bean.FileParam;
import com.zhu.framework.bean.FormParam;
import com.zhu.framework.bean.Param;
import com.zhu.framework.util.CollectionUtil;
import com.zhu.framework.util.FileUtil;
import com.zhu.framework.util.StreamUtil;
                        ...
                        for (FileItem fileItem : fileItemList) {
                            if (fileItem.isFormField()) {
                                ...
                                if (StringUtil.isNotEmpty(fieldName)) {
                                    ...
                                    fileParamList.add(
                                            new FileParam(fieldName, fieldName, fileSize, contentType, inputStream)
                                    );
                                }
                            }
                        }
